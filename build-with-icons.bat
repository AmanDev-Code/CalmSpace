@echo off
echo ===================================================
echo CalmSpace Android APK Build Script with Icon Generation
echo ===================================================
echo.

REM Install sharp for image processing
echo Installing sharp package for icon generation...
call npm install --save-dev sharp
if %ERRORLEVEL% NEQ 0 (
  echo Failed to install sharp! Please check your Node.js installation.
  exit /b 1
)
...
call node generate-app-icons.js
if %ERRORLEVEL% NEQ 0 (
