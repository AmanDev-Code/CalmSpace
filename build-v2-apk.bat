@echo off
echo ===================================================
echo CalmSpace v2 APK Build Script - With Auth Redirect Fix
echo ===================================================
echo.
...
if exist "calmspace-v2.apk" (
  del "calmspace-v2.apk"
)
...
REM Copy and rename the APK to v2
echo Copying APK to root as calmspace-v2.apk...
copy "android\app\build\outputs\apk\release\app-release.apk" "calmspace-v2.apk"
if %ERRORLEVEL% NEQ 0 (
  echo Failed to copy APK!
  exit /b 1
)
echo APK created successfully: calmspace-v2.apk
...
echo ===================================================
echo.
echo Signed APK created: calmspace-v2.apk
echo.
echo This version includes fixes for:
echo 1. Google authentication redirect flow
echo 2. Deep link handling for authentication
echo 3. Improved splash screen and authentication detection
echo.
...
if /i "%INSTALL_CHOICE%"=="Y" (
  ...
  adb install -r "calmspace-v2.apk"
  if %ERRORLEVEL% NEQ 0 (
