@echo off
echo ===================================================
echo CalmSpace Mobile-First APK Build Script
echo ===================================================
echo.
...
if exist "calmspace-mobile.apk" (
  del "calmspace-mobile.apk"
)
...
echo Copying APK to root as calmspace-mobile.apk...
copy "android\app\build\outputs\apk\debug\app-debug.apk" "calmspace-mobile.apk"
if %ERRORLEVEL% NEQ 0 (
  echo Failed to copy APK!
  exit /b 1
)
echo Debug APK created successfully: calmspace-mobile.apk
...
echo ===================================================
echo.
echo Debug APK created: calmspace-mobile.apk
echo.
echo This version includes:
echo 1. MOBILE-FIRST authentication approach
echo 2. Enhanced debugging and alerts for authentication flow
echo 3. More aggressive platform detection and handling
...
if /i "%INSTALL_CHOICE%"=="Y" (
  ...
  adb install -r "calmspace-mobile.apk"
  if %ERRORLEVEL% NEQ 0 (
